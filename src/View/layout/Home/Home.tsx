...
import { dataFAQs, projectsData, skillsData } from './dataHhome'
        ...
        <div style={styles.mainContainer}>
            ...
            <div style={styles.summaryContainer}>
                ...
                <h1 style={styles.greetingTitle}>
                    Hi, I'm <span style={{ color: Colors.cyan }}>Huy</span>,<br />
                    a{' '}
                ...
                <p style={styles.summaryDescription}>
                    Building scalable end-to-end solutions using the JS/TS ecosystem — React Native, Next.js, Node.js.
                    Specializing in RESTful APIs, secure integrations, real-time systems, and delivering
                    product-driven applications from database architecture to optimized UI.
                </p>
