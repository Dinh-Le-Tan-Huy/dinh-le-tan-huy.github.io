export const skillsData = [
    {
        id: "skills_lang_01",
        title: "Languages",
        des: "Core Programming Languages",
        responsibilities: [
            "JavaScript",
            "TypeScript",
            "Dart",
    ...
    },
    {
        ...
        des: "Modern Web & Mobile Development",
        responsibilities: [
            "React.js & Next.js",
            "React Native",
            "Flutter",
    ...
    },
    {
        ...
        des: "Server-side & Infrastructure",
        responsibilities: [
            "Node.js",
            "Express",
            "MongoDB"
    ...
    {
        id: "skills_concepts_04",
        title: "Architecture & Concepts",
        des: "Software Design & Methodologies",
        responsibilities: [
            "App Life-cycle",
            "Clean Architecture",
    ...
    },
    {
        ...
        des: "Productivity & Collaboration Tools",
        responsibilities: [
            "Figma (Design UI/UX)",
            "Postman & Swagger",
            "Docker",
...
export const educationData = [
    {
        ...
        des: "Certificates & Specialized Courses",
        responsibilities: [
            "AWS Cloud Computing Course – Udemy | 2026",
            "React Native Developer – CSC / University of Science | 2025",
        ]
    },
    {
        id: "edu_lang_02",
        title: "Languages",
        des: "English Proficiency",
        responsibilities: [
            "TOEIC 600 (Official Certificate)"
        ]
    }
];
...
export const awardsData = [
    {
        ...
        des: "LTTC (Language & Technology Training Center)",
        responsibilities: [
            "Awarded 50% Tuition Scholarship for outstanding academic performance.",
            "Recognized for maintaining high GPA and active contribution to the learning community."
        ]
    },
    {
        id: "award_02",
        title: "Top 5 Final Project",
        des: "LTTC Mobile App Showcase (2024)",
        responsibilities: [
            "Recognized as one of the top 5 best-performing projects in the graduation showcase.",
            "Evaluated based on UI/UX Design, Technical Complexity, and Problem-Solving capabilities."
        ]
    }
];
